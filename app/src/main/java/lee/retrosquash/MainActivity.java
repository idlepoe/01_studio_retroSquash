...
//                racketBottom -=50;
                ...
                int ballLeft = ballPosition.x;
                int ballTop = ballPosition.y;
                int ballRight = ballPosition.x + ballWidth;
                int ballBottom = ballPosition.y + ballWidth;


                //Draw the squash racket
                canvas.drawRect(racketLeft,
                        racketTop, racketRight,
                        racketBottom, paint);

                //Draw the ball
                canvas.drawRect(ballLeft, ballTop,
                        ballRight, ballBottom, paint);
